...
public class DevAppServerTestRunnerImproved extends BlockJUnit4ClassRunner {

    public DevAppServerTestRunnerImproved(Class<?> klass) throws InitializationError {
    ...
    private static Class<?> startServerAndIsolateClass(Class<?> klass) throws InitializationError {
        ...
        if (testAnno == null) {
            throw new InitializationError(String.format(
                    ...
                    DevAppServerTestRunnerImproved.class.getSimpleName(), DevAppServerTest.class.getSimpleName()));
        }
        try {
    ...
    /**
     * {@link org.junit.runners.model.TestClass} has 2 maps.  One maps annotation classes to a list of
     * {@link org.junit.runners.model.FrameworkMethod}, one entry in the list per method annotated with
     * the map key.  The other maps classes to a list of {@link org.junit.runners.model.FrameworkField},
